        ...
        return (
            <div className="min-h-screen bg-tmdbDarkBlue text-white flex items-center justify-center">
                <div className="text-xl p-6 bg-gray-800 rounded-lg shadow-xl text-center">
                    ...
                    <button
                        onClick={() => router.push('/')} // navigate yerine router.push kullanıyoruz
        ...
        <div className="min-h-screen bg-tmdbDarkBlue text-white pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                    <button
                        onClick={() => router.back()} // navigate(-1) yerine router.back() kullanıyoruz
                        ...
                        {filteredFavorites.length === 0 ? (
                            ...
                            <div className="space-y-6">
                                {filteredFavorites.map((item) => (
                                    ...
                                    >
                                        <div className="flex-shrink-0 w-24 h-36 relative"> {/* relative ekledik */}
                                        ...
                                        <div className="p-4 flex-1">
                                            <h3 className="text-xl font-bold text-white mb-1">{getTitle(item)}</h3> {/* text-black yerine text-white */}
                                            <p className="text-sm text-gray-300 mb-2"> {/* text-black yerine text-gray-300 */}
